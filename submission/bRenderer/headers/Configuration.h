...
namespace bRenderer
{
	...
	*/
	...
	std::string DEFAULT_SHADER_CUSTOM_MAP_1();
	std::string DEFAULT_SHADER_CUSTOM_MAP_2();
	std::string DEFAULT_SHADER_CUSTOM_MAP_3();
	...
	std::string CUSTOM_MAP_1();
	std::string CUSTOM_MAP_2();
	std::string CUSTOM_MAP_3();
